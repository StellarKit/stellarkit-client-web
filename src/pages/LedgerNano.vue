...
<div class='ledger-tab'>
  <div>
    ...
    <v-btn small @click="connectToLedger()">Connect to Ledger</v-btn>
    ...
    <div class='features-slider'>
      ...
      <div v-if='tabIndex === 0' class='feature-box'>
        ...
        <v-btn small @click="createNewAccount()">Create New Account for Ledger</v-btn>
      </div>
      ...
      <div v-else-if='tabIndex === 1' class='feature-box'>
        ...
        <v-btn small @click="giveLedgerSigningPower()">Give Ledger Signing Power</v-btn>
      </div>
      ...
      <div v-else-if='tabIndex === 2' class='feature-box'>
        ...
        <v-btn small @click="mergeAccountIntoLedger()">Merge Account into Ledger</v-btn>
      </div>
    </div>
